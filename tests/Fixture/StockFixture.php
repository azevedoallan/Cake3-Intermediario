...
class StockFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'stock_ibfk_1' => ['type' => 'foreign', 'columns' => ['product_id'], 'references' => ['products', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'unit_price' => 1.5,
                'unit_cost' => 1.5,
                'created' => '2019-10-29 02:56:57',
                'modified' => '2019-10-29 02:56:57'
            ],
        ];
        parent::init();
    }
